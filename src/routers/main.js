...
//router.use(bodyParser.urlencoded({ extended: false, inflate: false}))
...
router.post('/checkSupPay', bodyParser.json(), bodyParser.urlencoded({extended: true, type:'application/x-www-form-urlencoded'}), checkSub)
